            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Album1">https://api-kominfo.kotabogor.my.id/Album</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Album2">https://api-kominfo.kotabogor.my.id/Album/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Album3">https://api-kominfo.kotabogor.my.id/AlbumCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-warning pe-none">POST</button></td>
                        <td id="Album4">https://api-kominfo.kotabogor.my.id/AlbumUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Album5">https://api-kominfo.kotabogor.my.id/AlbumDest/{id}</td>
                        <td><button class="btn btn-success float-end"
