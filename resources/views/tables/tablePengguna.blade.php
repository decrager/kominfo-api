            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Pengguna1">https://api-kominfo.kotabogor.my.id/Pengguna</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Pengguna2">https://api-kominfo.kotabogor.my.id/Pengguna/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Pengguna3">https://api-kominfo.kotabogor.my.id/PenggunaCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Pengguna4">https://api-kominfo.kotabogor.my.id/PenggunaUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Pengguna5">https://api-kominfo.kotabogor.my.id/PenggunaDest/{id}</td>
                        <td><button class="btn btn-success float-end"
            ...
            <div class="hljs-code">
                <pre>
                    <code class="language-json text-left pt-3">
                        ...
                        "Path to file": "https://api-kominfo.kotabogor.my.id/storage/images/fotoPengguna/{file_name}"
                    </code>
                </pre>
            </div>
        </div>
