            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Faq1">https://api-kominfo.kotabogor.my.id/Faq</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Faq2">https://api-kominfo.kotabogor.my.id/Faq/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq3">https://api-kominfo.kotabogor.my.id/FaqCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq4">https://api-kominfo.kotabogor.my.id/FaqUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq5">https://api-kominfo.kotabogor.my.id/FaqDest/{id}</td>
                        <td><button class="btn btn-success float-end"
            ...
            <div class="hljs-code">
                <pre>
                    <code class="language-json text-left pt-3">
                        {
                            "id": "int(11)",
                            "pertanyaan": "text", // Request Body
                            "jawaban": "text", // Request Body
