            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Faq1">https://kominfo.kotabogor-api.my.id/Faq</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Faq2">https://kominfo.kotabogor-api.my.id/Faq/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq3">https://kominfo.kotabogor-api.my.id/FaqCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq4">https://kominfo.kotabogor-api.my.id/FaqUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Faq5">https://kominfo.kotabogor-api.my.id/FaqDest/{id}</td>
                        <td><button class="btn btn-success float-end"
