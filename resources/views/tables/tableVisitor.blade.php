            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Visitor1">https://api-kominfo.kotabogor.my.id/Visitor</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Visitor2">https://api-kominfo.kotabogor.my.id/Visitor/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Visitor3">https://api-kominfo.kotabogor.my.id/VisitorCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Visitor4">https://api-kominfo.kotabogor.my.id/VisitorUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Visitor5">https://api-kominfo.kotabogor.my.id/VisitorDest/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <code class="language-json text-left pt-3">
                        {
                            ...
                            "total_visit": "bigint", // Fillabel | Required
