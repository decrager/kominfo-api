            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Dokumen1">https://kominfo.kotabogor-api.my.id/Dokumen</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Dokumen2">https://kominfo.kotabogor-api.my.id/Dokumen/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Dokumen3">https://kominfo.kotabogor-api.my.id/DokumenCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-warning pe-none">POST</button></td>
                        <td id="Dokumen4">https://kominfo.kotabogor-api.my.id/DokumenUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Dokumen5">https://kominfo.kotabogor-api.my.id/DokumenDest/{id}</td>
                        <td><button class="btn btn-success float-end"
