            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="agenda1">https://kominfo.kotabogor-api.my.id/Agenda</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="agenda2">https://kominfo.kotabogor-api.my.id/Agenda/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="agenda3">https://kominfo.kotabogor-api.my.id/AgendaCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="agenda4">https://kominfo.kotabogor-api.my.id/AgendaUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="agenda5">https://kominfo.kotabogor-api.my.id/AgendaDest/{id}</td>
                        <td><button class="btn btn-success float-end"
