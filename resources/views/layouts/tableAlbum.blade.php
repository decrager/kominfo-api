            ...
            <table class="mb-2">
                <tbody class="mb-2">
                    <tr>
                        ...
                        <td id="Album1">https://kominfo.kotabogor-api.my.id/Album</td>
                    ...
                    <tr>
                        <td class="col-1" scope="row"><button
                                class="btn btn-outline-success pe-none">GET</button></td>
                        <td id="Album2">https://kominfo.kotabogor-api.my.id/Album/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Album3">https://kominfo.kotabogor-api.my.id/AlbumCrt</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Album4">https://kominfo.kotabogor-api.my.id/AlbumUpd/{id}</td>
                        <td><button class="btn btn-success float-end"
                    ...
                    <tr>
                        ...
                        <td id="Album5">https://kominfo.kotabogor-api.my.id/AlbumDest/{id}</td>
                        <td><button class="btn btn-success float-end"
